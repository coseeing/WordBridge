...
LABEL_DICT = {
	...
	"gemini-2.0-flash": _("gemini-2.0-flash"),
	"gemini-2.0-flash-lite": _("gemini-2.0-flash-lite"),
	"google/gemini-2.5-pro-exp-03-25:free": _("gemini-2.5-pro-exp-03-25(free)"),
	"gpt-4o": _("gpt-4o"),
	"gpt-4o-mini": _("gpt-4o-mini"),
	"gpt-4.1": _("gpt-4.1"),
	"gpt-4.1-mini": _("gpt-4.1-mini"),
	"gpt-4.1-nano": _("gpt-4.1-nano"),
	"o1-mini": _("o1-mini"),
	"o1": _("o1"),
	"o3-mini": _("o3-mini"),
