...
comment_traditional_tw = "'{{response_previous}}'是錯誤答案，請修正重新輸出文字"
comment_simplified = "'{{response_previous}}'是错误答案，请修正重新输出文字"

COMMENT_DICT = {
	"ChineseTypoCorrectorSimple":{
		"traditional_tw": comment_traditional_tw,
		"simplified": comment_simplified,
	},
...
TEMPLATE_DICT = {
	"ChineseTypoCorrectorSimple":{
		"traditional_tw": simple_traditional_tw,
		"simplified": simple_simplified,
	},
	"ChineseTypoCorrector":{
		"traditional_tw": with_phone_traditional_tw,
		"simplified": with_phone_simplified,
	}
}
